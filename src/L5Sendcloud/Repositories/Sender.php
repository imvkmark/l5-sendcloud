<?php namespace Imvkmark\L5Sendcloud\Repositories;

use Imvkmark\L5Sendcloud\Contracts\Sender as SenderInterface;
use Curl\Curl;
...
class Sender implements SenderInterface {
	...
	// 推送模板邮件
	protected function pushWithTemplate(Message $message, $template, array $data) {
		// 构造参数
		// 如果 不使用 maillist
	...
	private function buildParamWithMessage(Message $message, array $appendParam = []) {
